"""Regression checks for the atlas-parse-log-scope casebook."""
...
from casebook.harness import assert_expected, atlas_parse_log_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(atlas_parse_log_scope_summary(), assert_expected())
